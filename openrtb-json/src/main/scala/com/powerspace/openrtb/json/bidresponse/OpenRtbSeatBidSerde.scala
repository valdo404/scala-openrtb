...
/**
  ...
  */
class OpenRtbSeatBidSerde(implicit er: ExtensionRegistry) extends EncoderProvider[BidResponse.SeatBid] {
  ...
  private implicit val bidEncoder: Encoder[SeatBid.Bid] = new OpenRtbBidSerde().encoder
